...
// ExtractAddress extracts the address for the account that signed the data.
// The address is the public key ID of the signed data.
func ExtractAddress(value any, v, r, s *big.Int) (string, error) {
